...
* You can do them using RMarkdown and turn them by submitting them 
  electronically on GitHub by the start of class on Monday, Sept. 4.
    ...
    * in the local repository, complete the exercises in RMarkdown using the 
      template `homework_01.Rmd`, 
    * knit the file to a PDF file, 
    * use git to commit all your changes to your local repository,
    * and push the changes from your local repository back to github.
